...
2/ Argumente numite(Named sau keyword arguments) - valorile transmise functiei sunt identificate pe baza numelui
Avantajul argumentelor numite (keyword)- nu ne mai intereseaza ordinea
3/ Argumente cu valori implicite(Default arguments)
Regule : Argumentele pozitionale sunt mentionate inaintea celor keyword( numite la apelul functiei)
"""
...
def f(a, b= 10): # deafult value for b b este optional
    print('a + 2*b =', a+2*b)
print(suma(3, 5)) # positional argumets
num = 20
val = 10
print(suma(val, num)) # positional arguments
print(suma(3, y= 20)) # positional first, keyword dupa
