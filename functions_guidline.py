...
Avantajele folosireii functilor:
...
Writing function guidelisne
1/0 functia trebuie sa realizeze un singur lucru
...
def medie(x, y):
    """ Returneaza media aritmetica celor doi parametrii x , y"""
    return ( x + y)/2
...
def divide(a,b):
    if b !=0:
        ...
        rezultat = 'Impartire la zero' # return 'Impartire la 0'
    return rezultat
