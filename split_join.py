# Spliting and joinning strings (Divizare si imbinare stringuri)
...
lista_substring = text.split()
print('Lista de subsiruri este:', lista_substring)
lista2 = text.split(' is ')
print('Lista de substringuri folosind split cu separatorul "is" :', lista2)
...
# Transformarea unei liste de caractere intr-un string
lista_c = [ 'a', 'l', 'e', 'x']
s= ''.join(lista_c)
