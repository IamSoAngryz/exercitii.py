# Nested list (liste imbricate) - liste avand elemente de tip lista.
...
#multidimensiona arrays (matrice) - elementele listei sunt liste de aceiasi lungime
matrix = [[1, 2, 5, 6], [4, 7, 8, 1]]
print('Matrice 2x4', matrix)
for l in matrix:
    print(l)
# afisare elemente din interiorul listelor
for l in matrix:
    for element in l:
        print(element)
