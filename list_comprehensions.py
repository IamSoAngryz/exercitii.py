# List comprehensions - metoda de a genera o lista noua pe baza unei liste vechi dupa un criteriu de selectie/generare
...
print('Lista lungimilor cu list comprehentions', lengths_c)

#  Generam o lista de carecatere pe baza unui string
curs = 'Python developer'
chars = [char for char in curs]
print('Lista carcterelor:', chars)
...
print('Lista valorilor pare generata cu list comprehentions', evens)
...
# Sintaxa extinsa (if else oprator): lista_noua = [expresie_if_else for value in iterable]
# Generam o lista care sa contina valorile din numbers daca valoarea este para , altfel stocheaza 0
evens_list = [value if value % 2 == 0 else 0 for value in numbers]
print('Lista noua cu valori pare si zero pe pozitile valorilor imapare:', evens_list)

numbers2 = [x + 2 if x > 6 and x <= 20 else x - 10 for x in numbers]
print('Lista obtinuta prin comprehation cu o expresie mai complexa:', numbers2)