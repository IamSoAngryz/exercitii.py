...
# Sintaxa de declararea/crearea unei liste este nume_lista = [elemente_declarate_prin_virgula]
...
# list si str sun iterables (iterabila, pot fi parcurse elemente unul cate unul intr-un for)
...
#negative indexes - elementele de la sfarsitului listei cand nu ii stim lungimea
print('Primul elemt afisat folosind index negativ', numbers[-6])
print('Primul elemt afisat folosind index negativ', numbers[-len(numbers)])
print('Ultimul element din lista este afisat cu index negativ -1',numbers[-1])
print('Ultimul caracter al stringului curs', curs[-1])

# slicing -accesarea unei felii din lista (sublista respectiv substring)
...
print('Primele 3 caracter din stringul curs', curs[:3])
print('Valorile din numbers, icepand cu pozitia 4',numbers[4:])
#ultimele n elemente folosim lista[len(lista)-n:]
print('Ultimele 4 carctere din curs sunt:', curs[len(curs)-4:])
